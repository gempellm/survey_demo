...
asnwers может быть пустым. Логика проверки корректности возможных ответов, прикрепленных к вопросу и их сопоставление с входящими ответами на вопрос, а также логика зависимости поведения от типа вопроса  не реализованы.<br />
